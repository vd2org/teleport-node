...
docker run -d --name teleport-node \
  ...
  ghcr.io/vd2org/teleport-node:v14.2.2
```
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v14.2.2/compose.yml |
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v14.2.2/compose.yml | docker compose -p teleport-node -f - up -d
```
