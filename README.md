...
docker run -d --name teleport-node \
  ...
  ghcr.io/vd2org/teleport-node:v14.3.11
```
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v14.3.11/compose.yml |
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v14.3.11/compose.yml | docker compose -p teleport-node -f - up -d
```
