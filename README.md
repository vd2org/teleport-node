...
docker run -d --name teleport-node \
  ...
  ghcr.io/vd2org/teleport-node:v15.1.8
```
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v15.1.8/compose.yml |
...
```shell
curl https://raw.githubusercontent.com/vd2org/teleport-node/v15.1.8/compose.yml | docker compose -p teleport-node -f - up -d
```
